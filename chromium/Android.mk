...
$(shell cp $(LOCAL_PATH)/prebuilt/x86/libwebviewchromium.so $(TARGET_OUT_SHARED_LIBRARIES))

$(shell mkdir -p $(TARGET_OUT_APPS)/webview/lib/x86)
$(shell ln -sf ../../../../$(TARGET_LIB_DIR)/libwebviewchromium.so $(TARGET_OUT_APPS)/webview/lib/x86/libwebviewchromium.so)
